...
var _reactDom = __webpack_require__(304);
...
var m=__webpack_require__(45),n=__webpack_require__(46),p=__webpack_require__(27),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(33),l=__webpack_require__(98),B=__webpack_require__(45),C=__webpack_require__(27),ba=__webpack_require__(99),da=__webpack_require__(100),ea=__webpack_require__(101),fa=__webpack_require__(102),ia=__webpack_require__(103),D=__webpack_require__(46);
...
var emptyObject = __webpack_require__(46);
var checkPropTypes = __webpack_require__(97);
var hyphenateStyleName = __webpack_require__(309);
...
var hyphenate = __webpack_require__(310);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.captureSelection = _this.captureSelection.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function products() {
      ...
      _axios2.default.get('/api/products').then(function (res) {
        ...
        var regulars = products.filter(function (product) {
          return !product.isSpecial;
        });
        var specials = products.filter(function (product) {
          return product.isSpecial;
        });
        _this2.setState({ specials: specials, regulars: regulars });
        document.location.hash = '/';
      });
    }
  }, {
    key: 'captureSelection',
    value: function captureSelection(ev) {
      console.log('capture', ev.target.value);
      this.setState({ productId: ev.target.value });
    }
  }, {
    key: 'makeRegular',
    value: function makeRegular(ev) {
      var _this3 = this;

      ev.preventDefault();
      console.log('make regular', this.state.productId);
      var id = this.state.productId;
      _axios2.default.put('/api/products/' + id, { isSpecial: false }).then(function (res) {
        return res.data;
      }).then(function () {
    ...
    value: function makeSpecial(ev) {
      ...
      var id = this.state.productId;
      _axios2.default.put('/api/products/' + id, { isSpecial: true }).then(function (res) {
        return res.data;
    ...
    value: function render() {
      var _state = this.state,
          regulars = _state.regulars,
          specials = _state.specials;
      var makeRegular = this.makeRegular,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Products2.default, { makeRegular: makeRegular, regulars: regulars, specials: specials, makeSpecial: makeSpecial, captureSelection: captureSelection })
      );
    }
  }]);
...
var Products = function Products(_ref) {
  var makeRegular = _ref.makeRegular,
      regulars = _ref.regulars,
      specials = _ref.specials,
      makeSpecial = _ref.makeSpecial,
      captureSelection = _ref.captureSelection;
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            regulars.map(function (regular) {
              return _react2.default.createElement(
                'option',
                { key: regular.id, value: regular.id },
                regular.name
              );
            })
          ),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            specials.map(function (special) {
              return _react2.default.createElement(
                'option',
                { key: special.id, value: special.id },
                special.name
              );
            })
          ),
